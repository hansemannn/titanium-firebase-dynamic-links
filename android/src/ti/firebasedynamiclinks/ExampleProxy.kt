...
// This proxy can be created by calling TitaniumFirebaseDynamicLinks.createExample({ message: 'hello world' })
@Kroll.proxy(creatableInModule = TitaniumFirebaseDynamicLinksModule::class)
